...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/lincolncornford/PycharmProjects/CarRental/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/lincolncornford/PycharmProjects/CarRental/venv/bin/deactivate.nu'
